            ...
            if i!=b:
                ...
                if i in model2list:
                    prob+=pulp.lpSum([ft[b][(b,l,t)]*t for t in Tn[b]])+pulp.lpSum([k[i][(i,l,m)]*P[i][l][0][m] for m in P[i][l][0]])-z[b][(b,i,l)]*M<=pulp.lpSum([ft[i][(i,l,t)]*t for t in Tn[i]])
                     ...
                     prob+=pulp.lpSum([ft[b][(b,l,t)]*t for t in Tn[b]])+model1Pool[(model1Pool['model_no']==i) & (model1Pool['line_no']==l)]['days'].item()-z[b][(b,i,l)]*M<=pulp.lpSum([ft[i][(i,l,t)]*t for t in Tn[i]])
                if b in model2list:    
                    ...
                    prob+=pulp.lpSum([ft[i][(i,l,t)]*t for t in Tn[i]])+model1Pool[(model1Pool['model_no']==b) & (model1Pool['line_no']==l)]['days'].item()-z[i][(i,b,l)]*M<=pulp.lpSum([ft[b][(b,l,t)]*t for t in Tn[b]])
...
rlt_df.columns=['id','vname','vvalue']
